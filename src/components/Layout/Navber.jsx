      ...
      <nav className='py-8'>
        <div className="container flex justify-between flex-wrap md:flex-nowrap gap-5">
          ...
          <div className='flex gap-5 md:gap-10 order-2 md:order-3'>
            <Link to="/login" className='flex gap-1.5 items-center text-base text-primary font-medium'><FaRegUser /> <span className='hidden md:block'>Login</span></Link>
            <Link to="/Cart" className="relative flex gap-1.5 cursor-pointer items-center">
              <FaBasketShopping className="text-xl" />{" "}
              <span className="hidden md:block">My Cart</span>{" "}
              <span className=" w-5 h-5 bg-blue-500 flex items-center justify-center rounded-full text-white text-[12px]">
                {cartCount}
              </span>
