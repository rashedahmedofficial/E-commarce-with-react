...
const Productcard = ({data }) => {
  return (
    <div className='p-2.5 border border-[#F2F2F2] bg-white rounded-2xl transition-all duration-300 hover:shadow-xl hover:-translate-y-2 '>
      <div className='rounded-2xl  overflow-hidden relative'>
       <Link to={`/shop/${data.id}`}> <img src={data?.thumbnail} alt="Flash-product " className='w-full transition-transform duration-300 hover:scale-110' /></Link>
